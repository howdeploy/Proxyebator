...
IMPORTANT: Use exactly `verify_main || exit 1` — do NOT follow the RESEARCH.md alternative of `local verify_exit=$?; exit $verify_exit`. The `|| exit 1` form is cleaner and correct.
